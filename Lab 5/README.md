...
### python exchange
![](Screenshots/2-mosquittotest.png)

### Install Paho
```
pi@raspberrypi:~ $ sudo pip3 install -U paho-mqtt
...
remote: Total 4491 (delta 547), reused 826 (delta 490), pack-reused 3562
Receiving objects: 100% (4491/4491), 1.37 MiB | 2.35 MiB/s, done.
Resolving deltas: 100% (2395/2395), done.
pi@raspberrypi:~ $ cd ~/iot/lesson5
pi@raspberrypi:~/iot/lesson5 $ python3 client.py
Connected with result code 0
$SYS/broker/publish/messages/dropped 9544892
$SYS/broker/publish/messages/received 73789285
$SYS/broker/publish/messages/sent 121116503
$SYS/broker/publish/bytes/received 13047535652
$SYS/broker/publish/bytes/sent 14654841558
```

### python exchange 2
![](Screenshots/4-python.png)

### python exchange 3
![](Screenshots/5-subraspi.png)
